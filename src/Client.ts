...
import { HostedApisClient } from "./api/resources/hostedApis/client/Client.js";
...
export class SpeechifyClient {
    ...
    protected _hostedApis: HostedApisClient | undefined;
    ...
    public get hostedApis(): HostedApisClient {
        return (this._hostedApis ??= new HostedApisClient(this._options));
    }
